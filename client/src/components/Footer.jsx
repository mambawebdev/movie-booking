        ...
        <footer className="px-6 mt-40 md:px-16 lg:px-36 w-full text-gray-300">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500 pb-14">
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    <div>
                        <h2 className="font-semibold mb-5 text-primary/90">Company</h2>
                        <ul className="text-sm space-y-2">
                            <li><Link to={'/'}>Home</Link></li>
                            <li><Link to={'/movies'}>Movies</Link></li>
                            <li><Link href="#">Theatres</Link></li>
                            <li><Link href="#">Releases</Link></li>
                            <li><Link href="#">Privacy Policy</Link></li>
                        </ul>
                    </div>
                    <div>
                        <h2 className="font-semibold mb-5 text-primary/90">Get in touch</h2>
